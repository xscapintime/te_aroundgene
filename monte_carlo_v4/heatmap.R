...
### logFC
log1pfc <- read.table("TE-upstrm_montecarlo_log1pfc.txt", sep = "\t", header = T, row.names = 1)
...
pdf("upstream1k_logfc_heatmap_clustered.pdf", width = 6, height = 8)
# pdf("upstream1k_logfc_heatmap.pdf", width = 6, height = 8)
